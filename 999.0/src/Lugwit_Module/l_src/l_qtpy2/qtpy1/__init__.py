...
PYSIDE_API = ['pyside2', 'PySide2']

os.environ.setdefault(QT_API, 'pyqt5')
assert os.environ[QT_API].lower() in (PYQT5_API + PYQT4_API + PYSIDE_API+PYQT6_API)

API = os.environ[QT_API]
API_NAME = {'pyqt5': 'PyQt5', 'pyqt': 'PyQt4', 'pyqt4': 'PyQt4',
            'pyside2': 'PySide2','pyqt6': 'PyQt6'}[API.lower()]
...
if API in PYSIDE_API:
    try:
        from PySide2 import __version__                            # analysis:ignore
        PYQT5 = False
        PYSIDE = True
    except ImportError:
